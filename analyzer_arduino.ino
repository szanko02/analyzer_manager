...
uint32_t COLOR1 = 32768;
uint32_t COLOR2 = 8421376;
uint32_t COLOR3 = 12615680;
uint32_t COLOR4 = 12582912;
...
// анимация
float SMOOTH = 0.3;        // плавность движения столбиков (0 - 1)
...
void loop() {
  ...
  if (Serial.available() > 0) {
    buferByte = (byte)Serial.read();
    //Serial.println(buferByte);
    if (buferByte == 0x00) {
      buferByte = (byte)Serial.read();
  
      FastLED.setBrightness((int)buferByte);
    } else if (buferByte == 0x01) {
      buferByte = (byte)Serial.read();
      buferByte1 = (byte)Serial.read();
      buferByte2 = (byte)Serial.read();
      
      COLOR1 = buferByte * 65536 + buferByte1 * 256 + buferByte2;
    } else if (buferByte == 0x02) {
      buferByte = (byte)Serial.read();
      buferByte1 = (byte)Serial.read();
      buferByte2 = (byte)Serial.read();
      
      COLOR2 = buferByte * 65536 + buferByte1 * 256 + buferByte2;
    } else if (buferByte == 0x03) {
      buferByte = (byte)Serial.read();
      buferByte1 = (byte)Serial.read();
      buferByte2 = (byte)Serial.read();
      
      COLOR3 = buferByte * 65536 + buferByte1 * 256 + buferByte2;
    } else if (buferByte == 0x04) {
      buferByte = (byte)Serial.read();
      buferByte1 = (byte)Serial.read();
      buferByte2 = (byte)Serial.read();
      
      COLOR4 = buferByte * 65536 + buferByte1 * 256 + buferByte2;
    } else if(buferByte == 0x07){
      SMOOTH = (byte)Serial.read();
      SMOOTH = SMOOTH / 100;
    }else {
